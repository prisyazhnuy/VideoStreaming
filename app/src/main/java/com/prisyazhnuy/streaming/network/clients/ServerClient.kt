package com.prisyazhnuy.streaming.network.clients
...
import com.prisyazhnuy.streaming.network.api.modules.AccountModuleImpl
...
class ServerClient {
    ...
    val account: AccountModule by lazy { AccountModuleImpl(retrofit.create(AccountApi::class.java)) }
